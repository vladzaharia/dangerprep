...
// Note: ErrorPatterns and ErrorAggregator are temporarily excluded due to circular dependencies
// They will be moved to a separate package or refactored when logging and notifications are packaged

...
# Copy password file with correct permissions
if [ -f "/tmp/ca_password" ]; then
    cp /tmp/ca_password /home/step/secrets/password
    chmod 600 /home/step/secrets/password
    chown step:step /home/step/secrets/password
    echo "Password file copied and permissions set"
else
    echo "Warning: CA password file not found at /tmp/ca_password"

            ...
            <div className="wa-stack service-card">
              <div className="service-card-header">
                ...
                <div className="wa-stack service-info">
                  ...
                  <wa-skeleton effect="sheen" style={{ width: `${100 + (index * 20)}px`, height: '24px' }}></wa-skeleton>
                  {/* Service description skeleton - paragraph-like with varying widths */}
                  <wa-skeleton effect="sheen" style={{ width: `${180 + (index * 30)}px`, height: '16px' }}></wa-skeleton>
                </div>
              </div>
              <div className="service-card-footer">
                {/* URL text skeleton */}
                <wa-skeleton effect="sheen" style={{ width: `${120 + (index * 15)}px`, height: '16px' }}></wa-skeleton>

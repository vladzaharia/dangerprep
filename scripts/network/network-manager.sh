...
# Dependencies: network-state.sh, network-intelligence.sh, network-functions.sh
...
# shellcheck source=../shared/network-functions.sh
source "${SCRIPT_DIR}/../shared/network-functions.sh"

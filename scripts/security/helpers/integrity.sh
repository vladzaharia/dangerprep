...
SECURITY_INTEGRITY_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

SCRIPT_VERSION="1.0"
SCRIPT_DESCRIPTION="AIDE File Integrity Monitoring"

# Source shared utilities
source "${SECURITY_INTEGRITY_SCRIPT_DIR}/../../shared/logging.sh"
source "${SECURITY_INTEGRITY_SCRIPT_DIR}/../../shared/errors.sh"
source "${SECURITY_INTEGRITY_SCRIPT_DIR}/../../shared/validation.sh"
source "${SECURITY_INTEGRITY_SCRIPT_DIR}/../../shared/banner.sh"
